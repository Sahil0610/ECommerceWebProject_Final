...
namespace WebProject_ECommerceBackend.Migrations
{
    ...
    [Migration("20250807220455_AddedItem10Products")]
    partial class AddedItem10Products
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebProject_ECommerceBackend.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebProject_ECommerceBackend.Entities.CartItem", b =>
                {
                    b.HasOne("WebProject_ECommerceBackend.Entities.User", "User")
                        .WithMany()
